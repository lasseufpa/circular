        ...
        <div>
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li>
                        <!--<a class="waves-effect waves-light btn red">Baixar app<i class="material-icons right">shop</i></a>-->
                        <a class="waves-effect waves-light" style="height:62px;"
                           href='https://play.google.com/store/apps/details?id=org.lasseufpa.Circular&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img
                                    style="width:170px;" alt='Disponível no Google Play'
                ...
                <li>
                    ...
                    <div class="collapsible-body">
                        <ul>
                            ...
                            <li><a class="switch "><i class="material-icons left">settings_remote</i>Loc. Circular<label
                                            style="float: right;"> <input id="checkbox-enable-bus" type="checkbox"
                                                                          onclick="setBus()" checked>
                                        <span class="lever "></label></span></a></li>
                            <li><a class="switch "><i class="material-icons left">flag</i>Pontos de parada <label
                                            style="float: right;"> <input type="checkbox" onclick="atualizaMarkes()"
                                                                          checked>
                                        <span class="lever "></label></span></a></li>
                            <li><a class="switch "><i class="material-icons left">call_made</i>Rota de ida <label
                                            style="float: right;"> <input type="checkbox">
                                        <span class="lever "></label></span></a></li>
                            <li><a class="switch "><i class="material-icons left">call_received</i>Rota de volta <label
                                            style="float: right;"> <input type="checkbox">
                                        <span class="lever "></label></span></a></li>
...
<footer class="page-footer">
    <div class="footer-copyright">
        <div class="row" style="margin-bottom:0px;">
            <div class="col s8">
                © 2017 - Alphamage tech - Page rendered in <strong>{elapsed_time}</strong>
                seconds. <?php echo (ENVIRONMENT === 'development') ? 'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?>
            </div>
            <div class="col s4">
                <a class="grey-text text-lighten-4 right" href="http://alphamage.com"><img style="width:150px;"
                                                                                           src="img/logo-menu-inline.png"/></a>
            </div>
        </div>
    </div>
</footer>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQ-Puh5fVMFscxdJlUHYamNA7fnmaoZzc&callback=initMap"
        async defer></script>
<div id="map-canvas"/>
